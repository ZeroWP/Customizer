...
class ZWPC_Plugin_Autoloader{
	...
	*/
	public function autoloadEngine( $class ){
		$prefix   = zwpc_config( 'namespace' ) .'\\';
		$base_dir = ZWPC_PATH .'engine/';
	...
	*/
	public function autoloadComponents( $class ){
		$prefix   = zwpc_config( 'namespace' ) .'\\Component\\';
		$base_dir = ZWPC_PATH .'components/';
