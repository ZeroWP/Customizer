	...
	$.fn.ZWPC_Plugin_Admin = function( options ) {
		...
		this.build = function() {
			...
			var _base = {
				...
				-------------------------------------------------------------------------------
				*/
				add_selected_font: function( selected_elem_from_list, parent_block ){
				...
				buildFonts: function(){
					...
					$('.zerowpc-fonts-block').each(function(){
						...
						self.add_selected_font( selected, $(this) );
					});
					...
					$('.zerowpc-fonts li').not('.zerowpc-font-heading-title').on('click', function(){
						...
						// Add class to the "selected font" block
						self.add_selected_font( $(this), $(this).parents('.zerowpc-fonts-block') );
