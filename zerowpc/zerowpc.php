...
class ZeroWPC{
	 ...
	 * Panel
	 *
	 * Keep the current panel ID. It may not exists.
	 *
	 * @return string 
	 */
	protected $panel = '';
	 ...
	 * Default section
	 *
	 * This is the section used as a fallback.
	 *
	 * @return string 
	 */
	protected $defaultSection = 'title_tagline';
	...
	*/
	...
	/**
	 * Register all controls for use in this plugin
	 *
	 * @return void 
	 */
	public static function prepareControls(){
 ...
 * Preparation
 *
 * Register the built-in and custom controls for use.
 */
ZeroWPC::prepareControls();
...
/**
 * Register and/or enqueue customizer assets
 */
new ZeroWPC\Assets\Config;
...
$ctz->addSection( 'x_test', 'Test fields' );

$ctz->addField( 'x1', 'font', array(
	'label' => 'Font test',
	// 'default' => 'yes3',
	// 'priority' => 201,
) );

$ctz->addField( 'x2', 'upload', array(
	'label' => 'Upload',
	// 'default' => 'yes3',
	// 'priority' => 201,
) );

$ctz->addField( 'x3', 'cropped_image', array(
	'label' => 'Cropped image',
	// 'default' => 'yes3',
	// 'priority' => 201,
) );
...
$ctz->addField( 'xerox[a1]', 'text', array(
	'label' => 'A1',
	// 'default' => 'yes3',
	// 'priority' => 201,
) );

$ctz->addField( 'xerox[a2]', 'text', array(
	'label' => 'A2',
	// 'default' => 'yes3',
	// 'priority' => 201,
) );
...
add_action( 'wp_head', function(){
	echo '<pre>';
	print_r( get_theme_mod( 'x1' ) );
	print_r( get_theme_mod( 'xerox' ) );
	echo '</pre>';
}, 100 );
add_action( 'wp_head', function(){
	echo '<pre>';
	print_r( ZeroWPC::getCustomizerContainers() );
	echo '</pre>';
}, 1000 );